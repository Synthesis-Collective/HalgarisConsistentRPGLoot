...
{
    public class NewArmorAnalyzer
    {
        private readonly ArmorSettings _settings = Program.Settings.ArmorSettings;
        ...
        public NewArmorAnalyzer(IPatcherState<ISkyrimMod, ISkyrimModGetter> state,
        ...
        private FormKey GenerateEnchantment(int rarity)
        {
            ...
            var unusedTakeMin = Math.Min(rarityEnchCount, AllRpgEnchants[rarity].Count);
